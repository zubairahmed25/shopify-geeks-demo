            ...
            <div className="col-lg-6 col-md-8 col-sm-8 order-2">
              ...
              >
                <div className="about-content">
                  ...
                  <p>
                    We’re west coast change-makers, in a complex world. The
                    brands we support are positioned to be purposeful and
                    powerful while also fluid.
                  </p>
                  <ul>
                    <li>
                      <Link to={"#"}>
                    ...
                    <li>
                      <Link to={"#"}>
                        ...
                        Processing Special Skill or Knowledge
                      </Link>
                    </li>
                  </ul>
                  <Link
                  ...
                  >
                    <span>
                      ...
                      <img
                        src={
                          process.env.PUBLIC_URL + "/images/icon/btn-arrow.svg"
                        }
                        alt="images"
                      />
                    </span>
